...
# # --- TEMPORARY DIAGNOSTIC — remove once you've confirmed everything works ---
# print(f"[STARTUP CHECK] DATABASE_URL env var found: {bool(database_url)}")
# print(f"[STARTUP CHECK] Using database engine: {DATABASES['default']['ENGINE']}")
# print(f"[STARTUP CHECK] CLOUDINARY_URL env var found: {bool(os.environ.get('CLOUDINARY_URL'))}")
# print(f"[STARTUP CHECK] DEBUG is: {DEBUG}")
# # --- end diagnostic ---
...
# --- TEMPORARY DIAGNOSTIC — remove once you've confirmed everything works ---
print(f"[STARTUP CHECK] DATABASE_URL env var found: {bool(database_url)}", flush=True)
print(f"[STARTUP CHECK] Using database engine: {DATABASES['default']['ENGINE']}", flush=True)
print(f"[STARTUP CHECK] CLOUDINARY_URL env var found: {bool(os.environ.get('CLOUDINARY_URL'))}", flush=True)
print(f"[STARTUP CHECK] DEBUG is: {DEBUG}", flush=True)
# --- end diagnostic ---
